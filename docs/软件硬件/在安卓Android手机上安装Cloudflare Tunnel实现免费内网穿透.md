...
第三步：创建隧道命令：cloudflared tunnel create TUNNEL_NAME，或者添加已有隧道命令：cloudflared tunnel token --cred-file ~/.cloudflared/TUNNEL_UUID.json  TUNNEL_NAME，查看隧道命令：cloudflared tunnel list
